...
public class Food {
   ...
   public Food(int mafood){
    ...
    public Food(int mafood, String foodname, Timestamp dateupdateprice, int price, String picture) {
        this.mafood = mafood;
        this.foodname = foodname;
    ...
    public Timestamp getDateupdateprice() {
        return dateupdateprice;
    }

    public void setDateupdateprice(Timestamp dateupdateprice) {
        this.dateupdateprice = dateupdateprice;
    }
